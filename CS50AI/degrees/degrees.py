...
def read_path(source, path):
    ...
    for movie_id, person_id in path:
        string_path.append((movies.get(movie_id, {}).get("title"), people.get(person_id, {}).get("name")))

    return [people.get(source, {}).get("name")] + string_path
